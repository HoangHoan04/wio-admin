...
export const enumData = {
  ...
  THEME_CODE: {
    ...
    BOHO_FLORAL_BROWN: { code: "BOHO_FLORAL_BROWN", name: "Hoa cỏ - Nâu" },
    DRAGON_PHOENIX_RED: { code: "DRAGON_PHOENIX_RED", name: "Long phụng - Đỏ" },
    RED_DOUBLE_HAPPINESS: { code: "RED_DOUBLE_HAPPINESS", name: "Song hỷ - Đỏ" },
  },
